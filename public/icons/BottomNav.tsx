          ...
          >
            ...
            <span
              ...
              style={{
                fontSize: 10,
                color: isActive
                  ? (mode === 'jinx' ? 'var(--purple-soft)' : 'var(--pink)')
                  : 'var(--text-muted)',
              }}
            >
              {tab.label}
...
function FindIcon({ active, mode }: { active: boolean; mode?: string }) {
  return (
    <svg width="26" height="26" viewBox="0 0 26 26" fill="none">
      <path
        d="M13 5C13 5 7 9.5 7 14.5C7 17.81 9.69 20.5 13 20.5C16.31 20.5 19 17.81 19 14.5C19 9.5 13 5 13 5Z"
        fill="white"
        fillOpacity="0.9"
      />
      <path
        d="M13 10V17M10 13.5H16"
        stroke={mode === 'jinx' ? '#9333EA' : '#FF2D6B'}
        strokeWidth="2"
        strokeLinecap="round"
      />
    </svg>
...
function EarningsIcon({ active }: { active: boolean; mode?: string }) {
  return (
    <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
      <path
        d="M11 3C11 3 5 6 5 11C5 14.31 7.69 17 11 17C14.31 17 17 14.31 17 11C17 6 11 3 11 3Z"
        fill={active ? 'currentColor' : 'none'}
        fillOpacity={active ? 0.15 : 0}
        stroke="currentColor"
        strokeWidth="1.5"
