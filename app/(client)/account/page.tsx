...
export default function AccountPage() {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState<string | null>(null) // moment id pending delete
  ...
  const handleUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Simulate progress (Supabase storage doesn't expose upload progress natively)
    ...
    if (!insertError) await fetchMoments()
      ...
      <div className="relative px-5 pt-14 pb-4">
        ...
        >
          ...
          <button
            ...
            className="flex flex-col items-center py-4 transition-all duration-150"
        ...
        {(profile?.jinxy_credits ?? 0) > 0 && (
          <div
            ...
            style={{ background: 'rgba(255,45,107,0.06)', border: '1px solid rgba(255,45,107,0.15)' }}
          >
        ...
        <div className="relative px-5 pb-8">
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-xs" style={{ color: 'var(--text-muted)', fontFamily: 'var(--font-body)' }}>
                {moments.length}/{MAX_MOMENTS} uploaded · Vendors see these before accepting
              </p>
            </div>
