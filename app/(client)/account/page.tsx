  ...
  const menuSections: MenuSection[] = [
    {
      ...
      items: [
        ...
        },
        {
          label: 'Privacy',
          icon: '🛡️',
          action: () => router.push('/account/settings?section=privacy'),
        },
      ],
    },
    {
    ...
    jinxSection,
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: '🚩',
          action: () => router.push('/account/report'),
        },
      ],
    },
    {
  ...
  return (
    <div className="min-h-dvh" style={{ background: 'var(--bg-base)' }}>
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 60% 25% at 50% 0%, rgba(255,45,107,0.05) 0%, transparent 60%)',
        }}
      />
          ...
          <div className="flex-1 flex items-center justify-center px-6">
            {currentAvatarMoment ? (
              ...
              <div className="flex flex-col items-center gap-4">
                ...
                <p
                  style={{ color: 'rgba(255,255,255,0.4)', fontFamily: 'var(--font-body)', fontSize: 14 }}
                >
