...
export default function JinxSchedulePage() {
  ...
  const fetchSchedule = async () => {
    ...
    const { data } = await supabase
      .from('bookings')
      .select(`
        id, status, duration_tier, duration_hours,
        agreed_rate, vendor_payout, scheduled_at, session_ends_at,
                          ...
                          <div className="flex items-center justify-between mb-1">
                            ...
                            <span
                              ...
                              style={{
                                ...
                                color: booking.status === 'active' ? '#00D97E' : '#FFB800',
